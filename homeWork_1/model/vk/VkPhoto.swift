...
class VkPhoto: Object {
    ...
    var likes: VkLikes? = VkLikes()//LinkingObjects(fromType: VkLikes.self, property: "likes")//
    var reposts: VkReposts? = VkReposts()//LinkingObjects(fromType: VkReposts.self, property: "reposts")
