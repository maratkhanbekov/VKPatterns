...
class CustomSquareIndicator: UIActivityIndicatorView {
    ...
    override func startAnimating() {
        self.backgroundColor = UIColor.animatorColors.backgroundColor
        
        myLayer.path = nil
        myLayer.lineWidth = 4
        
        myLayer.strokeColor = UIColor.animatorColors.color2.cgColor
        myLayer.fillColor = UIColor.animatorColors.color3.cgColor
